jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        titlecss:"display:table; position:relative; font:bold 14px \"Lucida Sans Unicode\",\"Lucida Grande\",sans-serif,Arial; color:#fff; white-space:nowrap; background-color:red; padding:10px; ",
        ribbonimagey:0,
        ribbonimagex:0,
        ...
        transition:"slice,elastic,flipwithzoom",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
            "Red box": {
                ...
                titlecss:"display:table; position:relative; font:16px \"Lucida Sans Unicode\",\"Lucida Grande\",sans-serif,Arial; color:#fff; white-space:nowrap; background-color:red; padding:10px;",
                textpositionmarginstatic:0,
                texteffectresponsivesize:600,
            ...
            "Navy box": {
                ...
                texteffectduration1:600,
                googlefonts:"",
                textpositionmarginright:18,
                textautohide:true,
                textstyle:"dynamic",
                texteffectslidedistance:30,
                texteffectslidedirection:"right",
                textcss:"display:block; padding:8px 16px; text-align:center; ",
                titlecss:"display:tabler; position:center; font:10px \"Lucida Sans Unicode\",\"Lucida Grande\",sans-serif,font-family:Georgia; color:white; white-space:nowrap; background-color:red; padding:10px;",
                textpositionmarginstatic:0,
                texteffectresponsivesize:600,
